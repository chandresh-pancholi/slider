...
import slider.image.shelly.com.slider.dynamicgrid.BaseDynamicGridAdapter;
import slider.image.shelly.com.slider.dynamicgrid.DynamicGridView;
...
public class ImageDisplayActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageGrid = (DynamicGridView) findViewById(R.id.grid);
...
//        imageGrid.setAdapter(imgAdapter);
        imageGrid.setAdapter(new ImageAdapter(this, imgURI,3));
        ...
        imageGrid.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                if (imgURI.isEmpty() ) {
                    ...
                    Intent intent = new Intent(ImageDisplayActivity.this, MyImageActivity.class);
                    ;
                    intent.putExtras(b);
...
*/
        imageGrid.setOnDragListener(new DynamicGridView.OnDragListener() {
            @Override
        ...
        imageGrid.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                imageGrid.startEditMode(position);
                return true;
            }
        });
        ...
        imageGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ImageDisplayActivity.this, parent.getAdapter().getItem(position).toString(),
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        info.targetView.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#0099FF")));
 ...
 */
    ...
    public void onBackPressed() {
        if (imageGrid.isEditMode()) {
            imageGrid.stopEditMode();
        } else {
            super.onBackPressed();
        }
    }
